...
<body>
    ...
    <div id="spinner"
        ...
        <div class="spinner-border text-main" role="status" style="width: 3rem; height: 3rem;"></div>
    </div>
    <!-- Spinner End -->
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12 text-center">
                            <button class="btn bg-main w-100 py-3 text-white" type="submit">Submit Now</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Back to Top -->
    <a href="#" class="btn btn-lg bg-main btn-lg-square rounded-circle back-to-top text-white"><i
        ...
        const observer1 = new IntersectionObserver((entries, observer) => {
            entries.forEach(entry => {
                if (entry.isIntersecting && entry.intersectionRatio >= 0.5) {
                    ...
                    observer1.unobserve(entry.target); // Only run once
                }
            });
        }, {
            threshold: 0.5
